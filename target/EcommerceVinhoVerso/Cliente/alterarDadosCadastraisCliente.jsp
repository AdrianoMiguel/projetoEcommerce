...
<div class="background-image">
    <div class="container d-flex justify-content-center align-items-start min-vh-100 py-5">
        <div class="form-container p-4 glass">
            <h3 class="text-center mb-4">ALTERAR DADOS CADASTRAIS DO CLIENTE</h3>
            <form action=CtrlClienteAtualizar method="post" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        <input type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="11" value="${cliente.cpf}">
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-1">
                        <input type="text" class="form-control" id="ddd" name="ddd" placeholder="ddd" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="2" value="${cliente.contato.telefone.ddd}">
                    </div>
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control" id="numerotel" name="numerotel" placeholder="Numero" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="9" value="${cliente.contato.telefone.numero}">
                    </div>
