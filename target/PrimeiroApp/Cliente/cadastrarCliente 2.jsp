...
<div class="background-image">
    <div class="container d-flex justify-content-center align-items-start min-vh-100 py-5">
        <div class="form-container p-4 glass">
            ...
            <form action=CtrlClienteSalvar method="post" >
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <input type="text" class="form-control" id="endResNum" name="endResNum" placeholder="Numero" >
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-6"><p>ENDERECO DE COBRANÇA</p></div>
                    <div class="form-group col-md-6"><button type="button" id="copiarEnderecoParaCobranca" class="btn btn-menor">Repetir Endereco Residencial</button></div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-3">
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <input type="text" class="form-control" id="endCobNum" name="endCobNum" placeholder="Numero" >
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-6"><button type="button" id="copiarEnderecoParaEntrega" class="btn btn-menor">Repetir Endereco Residencial</button><br></div>
        </div>
                <div class="form-row">
                ...
                <button type="button" id="addEndereco" class="btn">Adicionar Endereco de Entrega</button>
                <p>CONTATO</p>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control" id="numerotel" name="numerotel" placeholder="Numero" >
                </div>
                ...
                <button type="button" id="addCartao" class="btn">Adicionar Cartao<br></button>
                <p>SENHA</p>
                <div class="form-row">
                    <div class="form-group col-md-6">
