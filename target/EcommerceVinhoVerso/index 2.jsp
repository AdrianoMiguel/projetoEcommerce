...
<div class="background-image">
    <div class="container d-flex justify-content-center align-items-start min-vh-100 py-5">
        <div class="form-container p-4 glass">
            ...
            <form action=CtrlProdutoListar method="get" >
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label>Nome do Cliente:</label>
                    </div>
                    <div class="form-group col-md-7">
                        <select id="idClienteLogin" name="idClienteLogin" class="form-control">
                    ...
                    <div class="form-group col-md-2">
                        <button type="submit" class="btn btn-menor" id="btnConsultar">Login</button>
                    </div>
                </div>
            </form>
        </div>
